% dir-view-test(SECTION) | User Commands
%
% "June 19 2026"
...
dir-view-test - program to do something

# SYNOPSIS

**dir-view-test** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**dir-view-test** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

The application displays the file system structure as a tree and allows you to 
search for files and directories by name. By default, the current user's home 
directory is used as the starting directory.

The project is based on qt dirview-example project.
...
:   The system-wide configuration file to control the behaviour of
    dir-view-test. See **foo.conf**(5) for further details.
...
**dir-view-test** provides some return codes, that can be used in scripts:
...
sokol <sokol28.nik@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 sokol
